...
# 7. Check library crate versions
echo ""
echo "Checking library crate versions on crates.io..."
if ! ./scripts/check-lib-versions.sh; then
  echo ""
  echo "Error: Library crates need to be published first."
